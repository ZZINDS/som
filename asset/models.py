...
class Cities(models.Model):
    ...
    province = models.ForeignKey(Provinces, verbose_name=u'省份', related_name='province_city_set', on_delete=models.CASCADE)
...
class Areas(models.Model):
    ...
    city = models.ForeignKey(Cities, verbose_name=u'城市', related_name='city_area_set', on_delete=models.CASCADE)
