# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-10-15 03:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attchment', models.FileField(blank=True, null=True, storage=deploy.storage.FileStorage(), upload_to='salt/module/DxrSh8cFUtuXu3pRgg8Hmke8ThSBJuCKAEBSjPQxtQ3ewYl9wf7Wcj4WyVuPqCxYMyPrX9w58l3RbJDs', verbose_name='\u6a21\u5757\u4e0a\u4f20')),
