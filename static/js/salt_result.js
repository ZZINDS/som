        ...
        success:function (ret) {
            ...
            $.each(ret.result, function (i, item) {
                ...
                $.each(item, function(k,v){
                    if(k!="iftrue"){
                        if(rtype=="exec"){
                            html = html + "<div class='panel panel-default' style='background:#326420;border:none;'><div><b style='color: #" + color
                            ...
                            html = html + "<div class='panel panel-default' style='background:#e7d581;border:none;'><div><b style='color: #" + color
                                + "'>主机：<a data-toggle='collapse' data-parent='#accordion' href='#" +
                                k.replace(/[.]/g,"") + "' style='color: #" + color + "'>" + k + "</a></b></div><b><div id='" + k.replace(/[.]/g,"")
